...
next0(int c) {
    if (c == ’0’) { return &node1; }
    if ((c >= ’1’) && (c <= ’9’)) { return &node2; }
    return nullptr;
}
Node*
next1(int c) {
    if ((c >= ’0’) && (c <= ’9’)) { return &node2; }
    if (c == ’x’) { return &node3; }
    return nullptr;
}
Node*
...
Node*
next3(int c) {
    if ((c >= ’0’) && (c <= ’9’)) { return &node4; }
    if ((c >= ’A’) && (c <= ’Z’)) { return &node4; }
    return nullptr;
}
Node*
next4(int c) {
...
Node node1 = {&next1, &term1, nullptr};
Node node2 = {&next2, &term1, nullptr};
Node node3 = {&next3, nullptr, nullptr};
Node node4 = {&next4, &term1, nullptr};
```
...
std::vector<Shift> shift0 = {{&term0, &state1}};
std::vector<Reduce> reduce0 = {};
std::vector<Shift> shift4 = {{&term0, &state5}};
std::vector<Reduce> reduce4 = {};
std::vector<Shift> shift2 = {{&term1, &state6}};
std::vector<Reduce> reduce2 = {{&endmark, &rule0, true}};
std::vector<Shift> shift3 = {{&term2, &state4}};
std::vector<Reduce> reduce3 = {{nullptr, &rule1, false}};
std::vector<Shift> shift7 = {{&term2, &state4}};
