...
- [Calculator Grammar](https://github.com/inumerics/parser/blob/main/test/calculator.bnf)
- [Calculator Header ](https://github.com/inumerics/parser/blob/main/test/calculator.hpp)
- [Calculator Source ](https://github.com/inumerics/parser/blob/main/test/calculator.cpp)
...
- [Part 1: Pattern Matching with Finite States](https://youtu.be/EThLZFuO32s)
- [Part 2: Matching Strings with Finite States](https://youtu.be/BghMX0j_mcw)
- [Part 3: Converting Regular Expressions to Finite Automata](https://youtu.be/v5658AF0EDQ)
